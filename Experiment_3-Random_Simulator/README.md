...
When the program refreshes, the ellipse moves into a random position. At the same time, the spacebar resets the whole canvas with a random background colour.
