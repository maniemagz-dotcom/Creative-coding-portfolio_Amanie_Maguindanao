...
  pos = random(200,300); // Using random(range) to change the position variable every time the sketch runs
}
...
  triangle(150, 150, 200, 120, pos, 200); //x1, y1, x2, y2, x3, y3
}